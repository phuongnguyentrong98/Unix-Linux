# File-Text-Linux
##FILE TEXT : WORKING WITH FILE TEXT
...
```
sẽ lấy ra 5 dòng đầu của văn bản. 
...
sẽ lấy ra 3 dòng cuối của văn bản.
...
![dem file](https://user-images.githubusercontent.com/68736233/89335255-f6733900-d6c1-11ea-9d80-0eb4ca0b0bad.png)
...
![ps aux](https://user-images.githubusercontent.com/68736233/89208906-78426400-d5e7-11ea-94bd-b832be9be3dc.png)
   ...
   - Hiển thị các process sử dụng nhiều RAM nhất theo thứ tự từ cao xuống thấp :
   
```
ps -eo pid,ppid,cmd,%mem,%cpu --sort=-%mem | head
```
 
   - ![sd dung luong](https://user-images.githubusercontent.com/68736233/89546285-a1086a80-d82e-11ea-944f-9998255f2dba.png)
...
![fileb](https://user-images.githubusercontent.com/68736233/89548308-0d846900-d831-11ea-92d6-b245ef21727b.png)
